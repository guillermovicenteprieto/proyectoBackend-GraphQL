### Desafio: Reforma para usar GraphQL

### Refactorizando el código del proyecto para cambiar de API RESTful a GraphQL API

#### Se reforma la capa de routeo y el controlador para que los requests puedan ser realizados a través del lenguaje de query GraphQL. 

#### Se documentan las respuestas a través de capturas de pantalla, en archivos dentro de carpeta 'testGraphQL'.
